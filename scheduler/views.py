...
class AlpaccaCalendar(mixins.MonthCalendarMixin, generic.TemplateView):
    """月間カレンダーを表示するビュー"""
    template_name = 'scheduler/show.html'

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        calendar_context = self.get_month_calendar()
        #calendar_context = self.get_week_names()
...
class WeekWithScheduleCalendar(mixins.WeekWithScheduleMixin, generic.TemplateView):
    ...
    template_name = 'scheduler/week_with_schedule.html'
    model = Schedule
    date_field = 'date'
...
class MonthWithScheduleCalendar(mixins.MonthWithScheduleMixin, generic.TemplateView):
    ...
    template_name = 'scheduler/month_with_schedule.html'
    model = Schedule
    date_field = 'date'
...
class MyCalendar(mixins.MonthCalendarMixin, mixins.WeekWithScheduleMixin, generic.CreateView):
    ...
    template_name = 'scheduler/mycalendar.html'
    model = Schedule
    date_field = 'date'
